                  ...
                  return Container(
                    ...
                    child: Material(
                        ...
                        leading: CircleAvatar(
                          ...
                          title: Text(activity.title, style: TextStyle(fontWeight: FontWeight.bold, color: Theme.of(context).colorScheme.onSurface)),
                          subtitle: Text('${activity.subject} • ${activity.date}', style: TextStyle(color: Theme.of(context).textTheme.bodySmall?.color)),
                        trailing: activity.score != null
                            ? Container(
                                ...
                                child: Text('${activity.score}%', style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                              )
                            : null,
                      ),
                    ),
